...
class Graph():
    ...
    def set_weights(self, walks=None):
        ...
        for walk in walks:
            ...
            walk_reverse = walk[::-1]
            backward = zip(walk_reverse[:-1], walk_reverse[1:])
            cnt.update(forward)
            cnt.update(backward)
    ...
    def get_weights(self):
        return sorted(nx.get_edge_attributes(self.G, 'weight').iteritems(), key=lambda item:item[0])
